...
info.add(
    types.InlineKeyboardButton(text='👨‍💻 Админ & создатель', url='https://t.me/satanasat'),
...
gen.add(
    ...
    types.InlineKeyboardButton(text='🔝 user agent', callback_data='gen_agent'),
...
gen_agent = types.InlineKeyboardMarkup(row_width=1)
gen_agent.add(
    types.InlineKeyboardButton(text='🧬 Сгенерировать', callback_data='gen_agent'),
